...
```sh
python3 contribute.py --repository=git@github.com:user/repo.git
```
...
## :key: SSH Setup Requirement
**Important**: Make sure you have SSH set up for your GitHub account before using this script. If you haven't set up SSH yet, you can follow [GitHub's guide on generating an SSH key](https://docs.github.com/en/authentication/connecting-to-github-with-ssh) to get started.
...
## :lock: Making contributions private
...
To be able to execute the script you need to have Python3 and Git installed.
